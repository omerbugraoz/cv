          ...
          {data.workExperience.map((work) => (
            <div key={work.key}>
              <div className="flex justify-between">
                <a
                  className="hover:underline text-black font-semibold dark:text-blue-300"
                  href={work.website}
                  target="_blank"
      ...
      <section className="flex flex-col gap-2">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 md:gap-6 gap-2">
          {data.workProjectExperience.map((project) => (
            ...
            >
              <div className="flex justify-between">
                <p className="group-hover:underline text-black font-semibold dark:text-blue-300">
                  {project.project}
                </p>
                <p className="text-gray-600 dark:text-gray-300">
                  {project.company}
...
export default function Home() {
  return (
    <main className="container relative mx-auto overflow-auto md:p-16">
      <div className="flex flex-col gap-8 max-w-3xl mx-auto p-3 md:p-6">
